...
impl ToastKind {
    ...
    pub fn icon_mask(&self) -> &'static str {
        match self {
            ...
            ToastKind::Info => "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%236b7280' stroke-width='2'%3E%3Ccircle cx='12' cy='12' r='10'%3E%3C/circle%3E%3Cpath d='M12 16v-4m0-4h.01'%3E%3C/path%3E%3C/svg%3E", // ← ADD
        }
    }
}